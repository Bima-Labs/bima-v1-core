...
import {BimaPegStabilityModule} from "../../contracts/BimaPegStabilityModule.sol";
...
contract BimaPegStabilityModuleTest is TestSetup {
    ...
    function setUp() public virtual override {
        ...
        psm = new BimaPegStabilityModule(address(bimaCore), address(debtToken), address(mockUnderlyingToken));
    ...
    function test_GetUsbd() public {
        ...
        emit BimaPegStabilityModule_GetUsbd(USER, USER, underlyingtDepositAmount, 1000e18, block.timestamp);
        psm.getUsbd(USER, USER, underlyingtDepositAmount);
    ...
    function test_GetUsbd_NotEnoughLiquidty() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(
            BimaPegStabilityModule.BimaPegStabilityModule_NotEnoughLiquidty.selector,address(debtToken)
            ));
        psm.getUsbd(USER, USER, amountToDeposit);
        vm.stopPrank();
    }
    ...
    function test_Redeem() external {
        ...
        vm.expectEmit(true, true, false, true);
        emit BimaPegStabilityModule_Redeem(USER, USER, underlyingtDepositAmount, 1000e18, block.timestamp);
    ...
    function test_Redeem_NotEnoughLiquidty() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(
            BimaPegStabilityModule.BimaPegStabilityModule_NotEnoughLiquidty.selector,address(mockUnderlyingToken)
            ));
