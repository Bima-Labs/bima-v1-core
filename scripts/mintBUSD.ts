...
export const mintBUSD = async ({
  ...
  const babelVaultContract = await BabelVault__factory.connect(
    troveManagerAddress,
    signer
  );
*/
 ...
 */
  ...
  const depositedAmount = await troveManagerContract.getTroveStake(
    signerAddress
  );

  const debtAmount = await troveManagerContract.getTroveCollAndDebt(
    signerAddress
  );
...
// BabelCore deployed!:  0x9d57b30957905d9aB576F33046017a6a482C71FB
...
// BabelToken deployed!:  0x41e4abC51371Dd77d885aea664CB71EBac675D27
// BabelVault deployed!:  0x1602570B11D8C4D61Ba1c8BAD55C0BB677822Ab0
// PriceFeed setOracle!
