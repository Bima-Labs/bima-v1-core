...
async function main(hre) {
    try {
        ...
        // Deploy SortedTroves (no future addresses needed in args)
        ...
        const deployedAddress = await hre.midl.getDeployment("SortedTroves");
        console.log("SortedTroves Deployed Address:", deployedAddress.address);
    } catch (error) {
