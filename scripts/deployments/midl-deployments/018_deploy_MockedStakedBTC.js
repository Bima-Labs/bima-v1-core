...
async function main(hre) {
    try {
        ...
        // Deploy Mocked StakedBTC (no constructor arguments or dependencies)
        await hre.midl.deploy("StakedBTC", {
            args: [],
        });

        console.log("Deploying Mocked StakedBTC...");
        await hre.midl.execute();

        console.log("_________________________________________________");
        const deployedAddress = await hre.midl.getDeployment("StakedBTC");
        console.log("MOCKED StakedBTC Deployed Address:", deployedAddress.address);
    } catch (error) {
