...
async function main(hre) {
    try {
        ...
        // Deploy PriceFeed (no future addresses needed in args)
        ...
        const deployedAddress = await hre.midl.getDeployment("PriceFeed");
        console.log("PriceFeed Deployed Address:", deployedAddress.address);
    } catch (error) {
